    ...
    <Carousel fade>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p  className="caption-slide1">Luxury & Comfort Redefined</p>
      ...
      {/* Slide 2 */}
        <Carousel.Item>
          ...
          <Carousel.Caption>
            <h2>Relax & Enjoy</h2>
            <p  className="caption-slide2">Your Perfect Getaway Awaits</p>
      ...
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p  className="caption-slide3">Make Every Moment Special</p>
